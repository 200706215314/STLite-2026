...
本项目为 ACM 班数据结构课程（CS1951，2026 春季学期）的课程作业，要求实现与 C++
...
本学期要求完成四个容器：`sjtu::vector`，`sjtu::deque`，`sjtu::priority_queue`，`sjtu::map`.

本作业中的四个容器在接口和复杂度要求上与 STL 基本一致，不同部分详见各自的文件夹。
